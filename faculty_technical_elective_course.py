...
class FacultyTechnicalElectiveCourse(ElectiveCourse):
    ...
    def when_rejected(self, student):
        if self.reg_sys.is_there_empty_fte_section():
    ...
    def get_random_elective(self):
         courses = self.reg_sys.fac_tech_elective_courses
         return random.choice(courses)
     
     
    def __str__(self):
        return super().__str__() + "(FTE)"